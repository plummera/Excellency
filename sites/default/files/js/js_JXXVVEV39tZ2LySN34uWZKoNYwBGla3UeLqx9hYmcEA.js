...
new ScrollMagic.Scene({triggerElement: "#SGslideIn", duration: 200})
        .setTween("#glasses", 0.4, {left: "392px", display: "block", position: "relative"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideIn", duration: 200})
        .setTween("#lit", 0.4, {left: "650px", display: "block", position: "relative"})
        .addTo(controller);
