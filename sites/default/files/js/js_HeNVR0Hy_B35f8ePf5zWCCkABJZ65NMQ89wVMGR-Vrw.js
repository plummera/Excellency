...
var tween = new TimelineMax()
  .add(TweenMax.to($(".catPhoto-2", {opacity: 95}, {duration: 200})))
  .add(TweenMax.to($(".catPhoto-2"), 1.2, {css:{bezier:flightpath.entry}, ease:Power1.easeInOut}))
  .add(TweenMax.to($(".catPhoto-2"), 2, {css:{bezier:flightpath.looping}, ease:Power1.easeInOut}))
  .add(TweenMax.to($(".catPhoto-2"), 1, {css:{bezier:flightpath.leave}, ease:Power1.easeInOut}));

// build scene
new ScrollMagic.Scene({triggerElement: "#Neko", duration: 350, offset: 100})
          .setPin(".catPhoto-2")
          .setTween(tween)
