...
new ScrollMagic.Scene({triggerElement: "#trigger1"})
        .setTween("#glasses", 0.5, {left: "400px", display: "block"})
        .addIndicators({name: "glasses (duration: 10)"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#trigger2"})
        .setTween("#lit", 0.5, {left: "400px", display: "block"})
        .addIndicators({name: "lit (duration: 10)"})
        .addTo(controller);
