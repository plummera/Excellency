...
new ScrollMagic.Scene({triggerElement: "#SGslideIn"})
        .setTween("#glasses", 0.4, {left: "388px", display: "block"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideIn"})
        .setTween("#lit", 0.4, {left: "650px", display: "block"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#SGslideOut"})
        .setTween("#glasses", 0.4, {left: "1%", display: "none"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideOut"})
        .setTween("#lit", 0.4, {left: "85%", display: "none"})
        .addTo(controller);
