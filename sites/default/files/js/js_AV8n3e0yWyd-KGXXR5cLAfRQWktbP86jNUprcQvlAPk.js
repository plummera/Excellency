...
new ScrollMagic.Scene({triggerElement: "#SGslideIn"})
        .setTween("#glasses", 0.5, {left: "35%", display: "block"})
        .addIndicators({name: "glasses | in"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideIn"})
        .setTween("#lit", 0.5, {left: "51%", display: "block"})
        .addIndicators({name: "lit | in"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#SGslideOut"})
        .setTween("#glasses", 0.5, {left: "0", display: "none"})
        .addIndicators({name: "glasses | out"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideOut"})
        .setTween("#lit", 0.5, {left: "100%", display: "none"})
        .addIndicators({name: "lit | out"})
        .addTo(controller);
...
new ScrollMagic.Scene({triggerElement: "#kitteh"})
				.setTween("#kitteh > div", {y: "1000px", ease: Linear.easeNone})
				.addIndicators()
				.addTo(controller2);

new ScrollMagic.Scene({triggerElement: "#kitteh2"})
				.setTween("#kitteh2 > div", {y: "1000px", ease: Linear.easeNone})
				.addIndicators()
				.addTo(controller2);

new ScrollMagic.Scene({triggerElement: "#kitteh3"})
				.setTween("#kitteh3 > div", {y: "1000px", ease: Linear.easeNone})
				.addIndicators()
				.addTo(controller2);
;
/*!
