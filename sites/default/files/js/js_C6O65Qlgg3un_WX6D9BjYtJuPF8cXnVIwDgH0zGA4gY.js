...
new ScrollMagic.Scene({triggerElement: "#SGslideIn"})
        .setTween("#glasses", 0.4, {left: "35%", display: "block"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideIn"})
        .setTween("#lit", 0.4, {left: "51%", display: "block"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#SGslideOut"})
        .setTween("#glasses", 0.4, {left: "0", display: "none"})
        .addTo(controller);

new ScrollMagic.Scene({triggerElement: "#LitSlideOut"})
        .setTween("#lit", 0.4, {left: "75%", display: "none"})
        .addTo(controller);
