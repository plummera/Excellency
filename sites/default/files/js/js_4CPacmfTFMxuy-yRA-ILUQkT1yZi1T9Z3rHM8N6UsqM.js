...
var scene = new ScrollMagic.Scene({
        ...
        .setTween("#glasses", 0.5, {left: "400px", display: "block", position: "relative"}) // trigger a TweenMax.to tween
        .addIndicators({name: "1 (duration: 10)"}) // add indicators (requires plugin)
        .addTo(controller);
